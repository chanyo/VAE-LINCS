...
plt.colorbar()
plt.savefig('I_test_encoded_LINCS.png')
plt.close(fig)
...
plt.colorbar()
plt.savefig('I_train_encoded_LINCS.png')
plt.close(fig)




scipy.io.savemat('./result_VAE_LINCS.mat', mdict={'x_test_encoded': x_test_encoded, 'y_test': y_test,
